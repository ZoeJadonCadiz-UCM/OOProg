...
public class BSIT {
    ...
    public static boolean start(Scanner scanner) {
        String courseName = "Bachelor of Science in Information Technology (BSIT)";
        String description = "The Bachelor of Science in Information Technology (BSIT) is for people interested in computers, technology, and systems. Students learn software development, network management, web design, and information protection.";
        ...
        String[] skills = {
            ...
            "Good communication skills, especially when working in teams"
        };
        
        String salary = "Entry-level: P20,000 - P30,000 per month\nWith experience: P40,000 - P80,000 or more";
